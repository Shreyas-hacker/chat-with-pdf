...
"""
prompt_template = f'''SYSTEM: You are a helpful, respectful and honest e-commerence platform assistant. Always answer  in json format based on product information inputed. 
...
question = " This is a Xiaomi 13 Ultra smartphone with 5.7 inches display of FHD resolution. It's available in space grey and black with storage from 256GB to 1TB."
...
#
#
# # agent_executor.run("create a table named coding skills from the following information: haidong has a coding skill of 99, Tom has 50, John has 20")
# agent_executor.run("who has the best coding skill and what is his skill amount from table codingskills")
